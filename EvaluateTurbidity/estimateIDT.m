...
%     
  %   TR = calculateTurbidImage(J(:,:,1),cR,dmap,averageCossine,BinfR(:,:,1)); 
 %    averageCossine = 0.714;
     
     
 %    TG = calculateTurbidImage(J(:,:,2),cG,dmap,averageCossine,BinfR(:,:,2)); 
%     
 %    averageCossine = 0.681;
 %    TB = calculateTurbidImage(J(:,:,3),cB,dmap,averageCossine,BinfR(:,:,3)); 
%     
%     
%     T(:,:,1) = TR;
 %    T(:,:,2) = TG;
