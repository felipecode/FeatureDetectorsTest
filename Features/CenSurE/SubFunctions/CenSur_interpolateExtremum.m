function [ipts, np]=CenSur_interpolateExtremum(r, c,  t,  m,  b,  ipts, np)
...
% (r,c) no caso eh a posicao do maximo
% O o offset calculado do que ainda seria o maximo.
...
%fprintf('offsets interpolations \n');
%size(O)
